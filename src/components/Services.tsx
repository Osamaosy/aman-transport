  ...
  const services = [
    {
      ...
      description: "نقل العفش والأثاث بأمان تام مع ضمان شامل ضد أي أضرار محتملة"
    },
    {
      icon: <Zap className="w-8 h-8 text-emerald-500" />,
      title: "تخزين محترف",
      description: "مستودعات حديثة ومجهزة بأنظمة تحكم في المناخ والرطوبة لحفظ الأثاث"
    },
    {
      icon: <Users className="w-8 h-8 text-emerald-500" />,
      title: "تعبئة وتغليف متخصص",
      description: "استخدام أفضل مواد التعبئة والتغليف لحماية الأثاث أثناء النقل والتخزين"
    },
    {
      icon: <Target className="w-8 h-8 text-emerald-500" />,
      title: "نقل المكاتب والشركات",
      description: "خدمات متخصصة لنقل المكاتب والمؤسسات مع الحفاظ على سير العمل"
    },
    {
      icon: <Wrench className="w-8 h-8 text-emerald-500" />,
      title: "فك وتركيب احترافي",
      description: "فك وتركيب جميع أنواع الأثاث والعفش بواسطة فنيين متخصصين ومهرة"
    },
    {
    ...
    <section id="services" className="py-16 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-slate-800 mb-4">خدماتنا المتميزة</h2>
          <div className="w-16 h-0.5 bg-emerald-400 mx-auto mb-6"></div>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
            نقدم مجموعة شاملة من الخدمات المتخصصة في نقل وتخزين العفش والأثاث بأعلى معايير الأمان والجودة
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="text-center space-y-3">
                ...
                <h3 className="text-lg font-semibold text-slate-700 leading-snug">{service.title}</h3>
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white p-6 rounded-2xl shadow-lg max-w-4xl mx-auto">
            <h4 className="text-2xl font-bold mb-3">احصل على خدمة متميزة الآن!</h4>
